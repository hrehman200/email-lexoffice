                              ...
                              <div class="m-sm-4">
                                    ...
                                    <form method="post" action="<?= site_url('auth/signin') ?>">
                                          ...
                                          <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg" type="email" name="email" placeholder="Ihre E-Maildresse" value="<?php if ($_SESSION['login_error']) {
                                          ...
                                          <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-lg" type="password" name="password" placeholder="Passwort" value="<?php if ($_SESSION['login_error']) {
